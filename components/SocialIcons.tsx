    ...
    <div className={`flex items-center gap-4 ${className}`}>
      {socialLinks.map((s) => (
        <a
          ...
          aria-label={s.name}
          className="text-ink-mute transition-colors hover:text-gold-600"
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
