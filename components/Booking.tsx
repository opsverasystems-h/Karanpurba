  ...
  return (
    <section id="book" className="container-site py-20 md:py-28">
      ...
      <Reveal delay={0.1} className="mx-auto mt-10 max-w-3xl">
        {booking.url ? (
          <div className="overflow-hidden rounded-3xl border border-gold-400/30 bg-white">
            <iframe
              src={booking.url}
          ...
          <div className="flex flex-col items-center gap-4 rounded-3xl border border-ink-500/80 bg-ink-700/50 px-6 py-16 text-center">
            <span className="flex h-14 w-14 items-center justify-center rounded-full border border-gold-400/40 text-2xl text-gold-300">
              ◷
            </span>
